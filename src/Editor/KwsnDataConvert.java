...
public class KwsnDataConvert {
	...
	public static HashMap<String,List<Clip>> GetData(List<WSN.Sensor> sensors, List<WSN.Link> links) {
	...
	private static List<Clip> GetSensorClip (List<WSN.Sensor> sensors) {
		
		List<Clip> list = new ArrayList<Clip>();
		
		for(WSN.Sensor s : sensors) {
	...
	private static List<Clip> GetChannelClip (List<Clip> sensors ,List<WSN.Link> links) {
